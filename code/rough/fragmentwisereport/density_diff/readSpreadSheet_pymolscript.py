...
"""
abc
e.g. python readSpreadSheet_pymolscript.py 1xxe_rough/strongbounds_gt1_strand_pdb_not_1xxe_v2.xlsx 1xxe_resi124_139_medium -o 1xxe_rough/dist_1xxe_124_139
"""
     ...
     if args.output:
               with open(args.output,"w") as file_id:
                    ...
                    for ele in list_sheet:
                           count = count+1                           
                           dist_string="zz=cmd.distance('1XXE_0001 and i. %d and n. %s', '1XXE_0001 and i. %d and n. %s')\n" %(int(ele[0]),ele[1].encode('ascii','ignore'),int(ele[2]),ele[3].encode('ascii','ignore'))
