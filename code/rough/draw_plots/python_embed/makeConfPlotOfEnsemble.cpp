...
int runPythonForConfplot(std::string pythoncode, std::string pythonfunc, std::vector<std::vector<double>> phi, std::vector<std::vector<double>> psi, std::string protein_name){
