...
#def align_all_printbest(target=None,org_mol=None,mobile_selection='backbone',target_selection='backbone',cutoff=2, cycles=5, method='super'):
#def align_all_printbest(target=None,org_mol=None,mobile_selection='name ca',target_selection='name ca',cutoff=2, cycles=5, method='super'):
 """
