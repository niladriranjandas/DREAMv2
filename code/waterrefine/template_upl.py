...
inputStructuresGlob="PATH_TO_PDB"
import glob
import sys
...
for (name,scale,file) in [('all',1,"PATH_TO_NOE_TBL"),
...
#protocol.initDihedrals("constraints/1ygw_xplor_dihed.tbl",
#                       useDefaults=False)
