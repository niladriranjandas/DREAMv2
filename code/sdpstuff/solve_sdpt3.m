...
function [X eigens slacks Vec_cons_1st_eq] = solve_sdpt3(U,equality_cons,upper_bounds,lower_bounds,vdw_bounds,f)
...
%%%%%%%%%%%%%%%%%%changed by me to see if it works%%%%%%%%%%%%%%%%%
%U = eye(size(U,1));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
