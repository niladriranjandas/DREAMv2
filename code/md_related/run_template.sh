...
$GMX pdb2$GMX -f "$work_folder/$protein_name".pdb -water tip3p -o "$work_folder/$protein_name"_process.gro -ignh <<< 8
...
$GMX grompp -f $mdp_folder/ions.mdp -c "$work_folder/$protein_name"_solv.gro -p $work_folder/topol.top -o $work_folder/ions.tpr
...
$GMX grompp -f $mdp_folder/minim_disre_posre_long.mdp -c "$work_folder/$protein_name"_solv_ions.gro -p $work_folder/topol.top -o "$work_folder/$protein_name"_em.tpr
