...
[oppfile, filename_grps] = doLocalizeFragment_sepprocess_pre(protein_name,test.cI_modified,hydrogen_omission,rand_X,Comp.Cq, Comp.info, test.dup_flag, test.cI_modified_org, eq_cons_all, up_bounds, wh_vdw_bounds, vdw_bounds, sdp_lo_bounds, lo_bounds, wh_lo_bounds);

prelocalizefile = sprintf('localize_tmp/%s/preloc_%s.mat',protein_name,protein_name);
save(prelocalizefile)
