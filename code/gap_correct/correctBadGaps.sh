...
cd waterrefine
bkp_xplornoe_name=$xplornoe_name"_bkp"
[ -f "$proteinname/$xplornoe_name" ] && mv $proteinname/$xplornoe_name $proteinname/$bkp_xplornoe_name
python3 ../../packages/xplor-nih-3.0.3/removeUplEntry.py $proteinname/$bkp_xplornoe_name $proteinname/$prot_convert $proteinname/$xplornoe_name 
echo "water-refine Remove empty entries $proteinname/$prot_convert: $?" >> $LOG_MASTER
if [ ! -z "$xplordihed" ]; then
