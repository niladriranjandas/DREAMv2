...
#from myseq import A_dict, AAA_dict  #changed 11-02-23 niladri

import sys
import re

######################### changed 10-02-23 niladri ########################
...
import os.path
import __main__
#s = __main__.session                                                  # changed 11-02-23 niladri 
#dist_file = s.open_filedialog('Select a distance restraint file.',    # changed 11-02-23 niladri
dist_file = sys.argv[1]                                                # changed 11-02-23 niladri
target_file = sys.argv[2]                                              # changed 11-02-23 niladri
...
#p = os.path.dirname(dist_file)                                         # changed 11-02-23 niladri 
#if dist_file.endswith('.upl'):                                         # changed 11-02-23 niladri 
#  target_file = s.save_filedialog('Save as...',                        # changed 11-02-23 niladri 
#    'XPLOR TBL (*.tbl);; Any (*)', p)                                  # changed 11-02-23 niladri   
#  if target_file == '':                                                # changed 11-02-23 niladri 
#    raise SystemExit                                                   # changed 11-02-23 niladri 
#  text = upl2tbl(dist_file)                                            # changed 11-02-23 niladri 
#elif dist_file.endswith('.tbl'):                                       # changed 11-02-23 niladri 
#  seq_file = s.open_filedialog('Select a sequence file.',              # changed 11-02-23 niladri 
#    'Sequence file (*.seq *.fasta *.txt);; Any (*)', p)                # changed 11-02-23 niladri   
#  target_file = s.save_filedialog('Save as...',                        # changed 11-02-23 niladri 
#    'DIANA UPL (*.upl);; Any (*)', p)                                  # changed 11-02-23 niladri 
#  if target_file == '':                                                # changed 11-02-23 niladri 
#    raise SystemExit                                                   # changed 11-02-23 niladri   
#  text = tbl2upl(dist_file, seq_file)                                  # changed 11-02-23 niladri 
#else:                                                                  # changed 11-02-23 niladri 
#  raise SystemExit                                                     # changed 11-02-23 niladri 
...
if dist_file.endswith('.tbl') :
  if target_file == '':
    raise SystemExit
  text = tbl2upl(dist_file)
