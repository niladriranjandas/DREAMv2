...
_cffi_f_zmq_proxy_steerable(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_ParseTuple(args, "OOOO:zmq_proxy_steerable", &arg0, &arg1, &arg2, &arg3))
    return NULL;
  ...
  if (datasize != 0) {
    x3 = ((size_t)datasize) <= 640 ? alloca((size_t)datasize) : NULL;
    if (_cffi_convert_array_argument(_cffi_type(0), arg3, (char **)&x3,
            datasize, &large_args_free) < 0)
      return NULL;
  }
...
static int _cffi_const_ZMQ_BINDTODEVICE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_BINDTODEVICE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_BINDTODEVICE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_BLOCKY(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_BINDTODEVICE(lib);
}
...
static int _cffi_const_ZMQ_CONNECT_ROUTING_ID(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_CONNECT_ROUTING_ID);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_CONNECT_ROUTING_ID", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_CONNECT_TIMEOUT(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_CONNECT_ROUTING_ID(lib);
}
...
static int _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_AUTH(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_EVENT_HANDSHAKE_FAILED_AUTH);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_EVENT_HANDSHAKE_FAILED_AUTH", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_AUTH(lib);
}

static int _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL(lib);
}

static int _cffi_const_ZMQ_EVENT_HANDSHAKE_SUCCEEDED(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_EVENT_HANDSHAKE_SUCCEEDED);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_EVENT_HANDSHAKE_SUCCEEDED", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL(lib);
}
...
static int _cffi_const_ZMQ_EVENT_LISTENING(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_EVENT_HANDSHAKE_SUCCEEDED(lib);
}
...
static int _cffi_const_ZMQ_GSSAPI_NT_HOSTBASED(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_GSSAPI_NT_HOSTBASED);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_GSSAPI_NT_HOSTBASED", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_GSSAPI_NT_KRB5_PRINCIPAL(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_GSSAPI_NT_KRB5_PRINCIPAL);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_GSSAPI_NT_KRB5_PRINCIPAL", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_GSSAPI_NT_HOSTBASED(lib);
}

static int _cffi_const_ZMQ_GSSAPI_NT_USER_NAME(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_GSSAPI_NT_USER_NAME);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_GSSAPI_NT_USER_NAME", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_GSSAPI_NT_KRB5_PRINCIPAL(lib);
}
...
static int _cffi_const_ZMQ_GSSAPI_PLAINTEXT(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_GSSAPI_NT_USER_NAME(lib);
}
...
static int _cffi_const_ZMQ_GSSAPI_PRINCIPAL_NAMETYPE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_GSSAPI_PRINCIPAL_NAMETYPE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_GSSAPI_PRINCIPAL_NAMETYPE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_GSSAPI_SERVER(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_GSSAPI_PRINCIPAL_NAMETYPE(lib);
}
...
static int _cffi_const_ZMQ_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_HANDSHAKE_IVL(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_GSSAPI_SERVICE_PRINCIPAL_NAMETYPE(lib);
}
...
static int _cffi_const_ZMQ_MSG_T_SIZE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_MSG_T_SIZE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_MSG_T_SIZE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_MULTICAST_HOPS(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_MSG_T_SIZE(lib);
}

static int _cffi_const_ZMQ_MULTICAST_LOOP(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_MULTICAST_LOOP);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_MULTICAST_LOOP", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_MULTICAST_MAXTPDU(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_MULTICAST_LOOP(lib);
}
...
static int _cffi_const_ZMQ_NOTIFY_CONNECT(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_NOTIFY_CONNECT);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_NOTIFY_CONNECT", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_NOTIFY_DISCONNECT(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_NOTIFY_DISCONNECT);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_NOTIFY_DISCONNECT", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_NOTIFY_CONNECT(lib);
}
...
static int _cffi_const_ZMQ_NULL(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_NOTIFY_DISCONNECT(lib);
}
...
static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_BAD_REQUEST_ID(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZAP_BAD_REQUEST_ID);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZAP_BAD_REQUEST_ID", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_BAD_VERSION(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZAP_BAD_VERSION);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZAP_BAD_VERSION", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_BAD_REQUEST_ID(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_INVALID_METADATA(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZAP_INVALID_METADATA);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZAP_INVALID_METADATA", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_BAD_VERSION(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_INVALID_STATUS_CODE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZAP_INVALID_STATUS_CODE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZAP_INVALID_STATUS_CODE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_INVALID_METADATA(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_MALFORMED_REPLY(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZAP_MALFORMED_REPLY);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZAP_MALFORMED_REPLY", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_INVALID_STATUS_CODE(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_UNSPECIFIED(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZAP_UNSPECIFIED);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZAP_UNSPECIFIED", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_MALFORMED_REPLY(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_CRYPTOGRAPHIC(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_CRYPTOGRAPHIC);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_CRYPTOGRAPHIC", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZAP_UNSPECIFIED(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_METADATA(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_METADATA);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_METADATA", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_CRYPTOGRAPHIC(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_SEQUENCE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_SEQUENCE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_SEQUENCE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_METADATA(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_KEY_EXCHANGE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_KEY_EXCHANGE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_KEY_EXCHANGE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_INVALID_SEQUENCE(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_ERROR(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_ERROR);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_ERROR", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_KEY_EXCHANGE(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_HELLO(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_HELLO);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_HELLO", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_ERROR(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_INITIATE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_INITIATE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_INITIATE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_HELLO(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_MESSAGE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_MESSAGE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_MESSAGE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_INITIATE(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_READY(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_READY);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_READY", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_MESSAGE(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_UNSPECIFIED(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_UNSPECIFIED);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_UNSPECIFIED", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_READY(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_WELCOME(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_WELCOME);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_WELCOME", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_UNSPECIFIED(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MECHANISM_MISMATCH(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_MECHANISM_MISMATCH);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_MECHANISM_MISMATCH", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MALFORMED_COMMAND_WELCOME(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_UNEXPECTED_COMMAND(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_UNEXPECTED_COMMAND);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_UNEXPECTED_COMMAND", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_MECHANISM_MISMATCH(lib);
}

static int _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_UNSPECIFIED(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_PROTOCOL_ERROR_ZMTP_UNSPECIFIED);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_PROTOCOL_ERROR_ZMTP_UNSPECIFIED", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_UNEXPECTED_COMMAND(lib);
}
...
static int _cffi_const_ZMQ_PUB(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_PROTOCOL_ERROR_ZMTP_UNSPECIFIED(lib);
}
...
static int _cffi_const_ZMQ_ROUTER_NOTIFY(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_ROUTER_NOTIFY);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_ROUTER_NOTIFY", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_ROUTER_RAW(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_ROUTER_NOTIFY(lib);
}

static int _cffi_const_ZMQ_ROUTING_ID(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_ROUTING_ID);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_ROUTING_ID", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_SCATTER(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_ROUTING_ID(lib);
}
...
static int _cffi_const_ZMQ_THREAD_AFFINITY_CPU_ADD(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_THREAD_AFFINITY_CPU_ADD);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_THREAD_AFFINITY_CPU_ADD", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
static int _cffi_const_ZMQ_THREAD_AFFINITY_CPU_REMOVE(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_THREAD_AFFINITY_CPU_REMOVE);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_THREAD_AFFINITY_CPU_REMOVE", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_THREAD_AFFINITY_CPU_ADD(lib);
}

static int _cffi_const_ZMQ_THREAD_NAME_PREFIX(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_THREAD_NAME_PREFIX);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_THREAD_NAME_PREFIX", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_THREAD_AFFINITY_CPU_REMOVE(lib);
}
...
static int _cffi_const_ZMQ_THREAD_PRIORITY(PyObject *lib)
{
  ...
  if (res < 0)
    return -1;
  return _cffi_const_ZMQ_THREAD_NAME_PREFIX(lib);
}
...
static int _cffi_const_ZMQ_ZAP_ENFORCE_DOMAIN(PyObject *lib)
{
  PyObject *o;
  int res;
  o = _cffi_from_c_int_const(ZMQ_ZAP_ENFORCE_DOMAIN);
  if (o == NULL)
    return -1;
  res = PyObject_SetAttrString(lib, "ZMQ_ZAP_ENFORCE_DOMAIN", o);
  Py_DECREF(o);
  if (res < 0)
    return -1;
...
{
  return _cffi_const_ZMQ_ZAP_ENFORCE_DOMAIN(lib);
}
...
static PyMethodDef _cffi_methods[] = {
  ...
  {"zmq_proxy_steerable", _cffi_f_zmq_proxy_steerable, METH_VARARGS, NULL},
