...
# First energy file.
infile = open(glob.glob('../../epsilon-1_zeta-1_alpha/4width_10grid/epsilon-1_zeta-1_marginal/*_energy.dat')[0], 'r')
...
# Second energy file.
infile = open(glob.glob('../../delta-1_epsilon-1_zeta-1/4width_10grid/epsilon-1_zeta-1_marginal/*_energy.dat')[0], 'r')
contents = infile.read()
infile.close()
