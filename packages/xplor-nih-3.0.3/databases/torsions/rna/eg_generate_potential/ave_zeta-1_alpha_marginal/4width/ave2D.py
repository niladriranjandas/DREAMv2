...
# First energy file.
infile = open(glob.glob('../../zeta-1_alpha_beta/4width_10grid/zeta-1_alpha_marginal/*_energy.dat')[0], 'r')
...
# Second energy file.
infile = open(glob.glob('../../epsilon-1_zeta-1_alpha/4width_10grid/zeta-1_alpha_marginal/*_energy.dat')[0], 'r')
contents = infile.read()
infile.close()
