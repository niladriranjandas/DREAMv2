...
# First energy file.
infile = open(glob.glob('../../alpha_beta_gamma/4width_10grid/alpha_beta_marginal/*_energy.dat')[0], 'r')
...
# Second energy file.
infile = open(glob.glob('../../zeta-1_alpha_beta/4width_10grid/alpha_beta_marginal/*_energy.dat')[0], 'r')
contents = infile.read()
infile.close()
