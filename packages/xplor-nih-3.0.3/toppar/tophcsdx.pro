remarks file TOPPAR/tophcsdx_new.pro  (5/26/92)
REMARKS TOPHCSDx.PRO: Original XPLOR toph19x.pro modified according to
REMARKS R. A. Engh and R. Huber, Acta Cryst, Sect A, 1991)
REMARKS with additional atom types.
REMARKS ===============================
...
set echo=false end
!! 
!! for use with PARAM19x parameters ( no special hydrogen bonding potential )
...
RESIdue HISH   { Doubly protonated histidine.  Ring charges
...
PRES HIST     !  INVERSE PATCH FOR HISD TO HISH
              !  has to be patched as REFErence=NIL=<selection>
 ...
 ADD IC  CE1  CD2 *NE2  HE2 0.0 0.0 180.0 0.0 0.0

END {HIST}

!---------------------------------------------------------------------

PRESIDUE HISU   ! INVERSE PATCH FOR HISE to HISH
                ! has to be patched as REFErence=NIL=<selection>
 ...
 ADD IC  CE1  CG *ND1  HD1    0.0 0.0 180.0 0.0 0.0
