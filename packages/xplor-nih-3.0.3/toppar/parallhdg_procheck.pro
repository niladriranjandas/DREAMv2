remark file parallhdg_procheck.pro
remark   NOTE: these parameters are DEPRECATED. Please instead use protein.par.
remark Changed version of parallhdg_new.pro so that the bond lengths and angles 
remark agree with what PROCHECK expects.
remark JJK 9/14/98

!   file parallhdg_new.pro
!   geometric energy function parameters for distance geometry and
!   simulated annealing.  Modified by G.M.C. to have sigma's of Param19x and parafloat
...
! BONDS
 ...
 bonds     H    NB                 $kbon     0.98 ! protonated his, copied from his ND-HD bond JJK 7/2/99
 ...
 bond      C    C                  $kbon     1.38
 bond      C    CT                 $kbon     1.525  ! was 1.530 PROCHECK
 bond      C    N                  $kbon     1.305
 bond      C    NP                 $kbon     1.305
 bond      C    NR                 $kbon     1.305
 bond      C    NH1                $kbon     1.329  ! was 1.305 PROCHECK
 bond      C    NH2                $kbon     1.305
 bond      C    NC2                $kbon     1.305
 bond      C    O                  $kbon     1.231  ! was 1.215 PROCHECK
 bond      C    OC                 $kbon     1.22
 bond      C    OH                 $kbon     1.38
 ...
 bond      CP   CT                 $kbon     1.492 ! CP
 bond      CT   N                  $kbon     1.49
 bond      CP   N                  $kbon     1.473 ! CP
 bond      CP   NH3                $kbon     1.49  ! CP - proline at N terminus
 bond      CT   NH1                $kbon     1.458  ! was 1.490 PROCHECK
...
! ANGLES
 ...
 angle     HA   CP   NH3           $kang     109.5 ! CP, N-terminal pro
 ...
 angle     C    CT   CT            $kang     110.10 ! was 109.5 PROCHECK
 angle     C    CT   N             $kang     111.8 ! updated with CP
 angle     C    CT   NH1           $kang     111.2 ! was 109.5 PROCHECK
 ...
 angle     C    NH1  CT            $kang     121.7  ! was 120.0 PROCHECK was by JK unq. ARG
 ...
 angle     CV   NB   H             $kang     127.35 ! added for protonated his, JJK 7/2/99
 angle     CR   NB   H             $kang     127.35 ! added for protonated his, JJK 7/2/99
 angle     CT   C    N             $kang     116.9 ! updated with CP
 angle     CT   C    NH1           $kang     116.2 ! was 117.5 PROCHECK
 angle     CT   C    NH2           $kang     120.0
 angle     CT   C    O             $kang     120.80  ! was 121.25 PROCHECK was by JK (pept planarity)
 ...
 angle     CP   CP   NH3           $kang     103.2 ! CP, N-terminal pro
 angle     CP   CP   CT            $kang     106.1 ! CP
 angle     CP   CT   CT            $kang     104.5 ! CP
 angle     CT   CT   NH1           $kang     110.5 ! was 109.5 PROCHECK
 ...
 angle     CT   NH3  CP            $kang     109.5 ! CP, N-terminal pro
 ...
 angle     NH1  C    O             $kang     123.00 ! was 121.25 PROCHECK was by JK (pept planarity)
...
! rotatable bonds. 
 ...
 improper  CP   CT   CT   N        $kpla    0    0.0    ! new pro ring pucker --JK
 improper  CP   CT   CT   NH3      $kpla    0    0.0    ! CP, N-terminal pro
...
! stereospecific hydrogen impropers
 ...
 improper  HA   HA   NH3  C        $kchi   0   -70.874  ! stereo N-terminal GLY CA JJK 8/16/02
...
! need to get better values for this
 ...
 improper  HA   HA   CP   NH3      $kchi   0   -70.874  ! CP methylene N-terminal
