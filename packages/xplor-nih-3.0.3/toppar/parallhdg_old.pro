...
! between trans and cis by a patch. 
 ...
 improper  N    CT   CT   CT       $kback   0   25.     ! proline ring pucker
...
! stereospecific hydrogen impropers
 ...
 improper  HA   HA   NH3    C      $kchi   0   -70.874  ! stereo GLY CA at NTER (P. Discroll 7/25/93)
 improper  HA   HA   CT   HA       $kchi   0   -66.514  ! methyl
 improper  HA   HA   C    HA       $kchi   0   -66.514  ! methyl (for ACE)
