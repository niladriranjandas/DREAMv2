...
! for floating assignment, set KMENE to 0
...
! BONDS
 ...
 bond      CP   CP                 $kbon     1.50
 bond      CP   CT                 $kbon     1.49
 bond      CP   N                  $kbon     1.47
 bond      CP   NH3                $kbon     1.47
 bond      CP   HA                 $kbon     1.08
 bond      S    S                  $kssbon   2.02
 bond      H    NB                 $kbon     0.98
 bond      CC   NB                 $kbon     1.385
 bond      CV   NA                 $kbon     1.394
...
! ANGLES
 ...
 angle     CT   CT   N             $kang     104.0 ! MN, from parhcsdx.pro
 angle     CT   CT   NH1           $kang     104.0 ! MN, from parhcsdx.pro
 angle     CT   CT   NH2           $kang     104.0 ! MN, from parhcsdx.pro
 angle     CT   CT   NH3           $kang     104.0 ! MN, from parhcsdx.pro
 angle     CT   CT   NC2           $kang     109.5
 angle     CT   CT   OH            $kang     109.5 !corrected by JK
 angle     CT   CT   S             $kang     109.5
 angle     CT   CX   CW            $kang     125.0000
 angle     CT   N    CT            $kang     119.0 
 ...
 angle     CT   CT   CP            $kang     104.500 !\
 angle     CT   CP   CP            $kang     106.100 ! \
 angle     CP   CP   N             $kang     103.200 !  > from parhcsdx.pro
 angle     C    N    CP            $kang     125.000 ! /
 angle     CT   N    CP            $kang     112.000 !/
 angle     CP   CP   NH3           $kang     103.200 
 angle     C    NH3  CP            $kang     125.000
 angle     CT   NH3  CP            $kang     112.000
 angle     HA   CP   HA            $kang     109.5
 angle     HA   CP   CP            $kang     109.5
 angle     HA   CP   CT            $kang     109.5
 angle     HA   CT   CP            $kang     109.5
 angle     HA   CP   N             $kang     109.5
 angle     HA   CP   NH3           $kang     109.5
 ...
 angle     H    NB   CV            $kang     120.0
 angle     H    NB   CR            $kang     120.0
...
! between trans and cis by a patch. 
 ...
 improper  CP   C    N    CT       $kback   0  180.0    ! proline
 improper  O    C    NH1  CT       $kback   0    0.0    ! CO planarity
 improper  O    C    N    CT       $kback   0    0.0    ! CO planarity, proline
 ...
 improper  C    O    NH1  CT       $kback   0    0.0    !! new cis CO planarity
 improper  C    O    N    CT       $kback   0    0.0    !! new cis CO planarity, proline
 improper  NH1  H    C    CT       $kback   0    0.0    !! new cis NH peptide planarity
 improper  N    CT   CT   CP       $kback   0   25.     ! proline ring pucker
 improper  NH3  CT   CT   CP       $kback   0   25.     ! proline ring pucker
 improper  C    CP   N    CT       $kback   0  180.0    ! Pro cis peptide    5/21/96
...
! isolated CAs minimized with bonds and angles only --JK
 ...
 improper  HA   CT   CT   CT       $kmene    0   -65.977  ! val, leu, ile chirality

! hold tetrahedral groups in the proper positions
! these were also computed by minimising isolated groups

 improper  HA   HA   CT   HA       $kmtyl   0   -66.514  ! methyl
 improper  HA   HA   S    HA       $kmtyl   0   -66.0    ! met methyl
 improper  HC   HC   CT   HC       $kmtyl   0   -66.0    ! amine for lys & N terminus
 improper  HA   HA   CT   CT       $kmene   0   -70.874  ! methylene
 improper  HA   HA   CT   CA       $kmene   0   -70.874  ! methylene phe 
 improper  HA   HA   CT   CX       $kmene   0   -70.874  ! methylene trp
 improper  HA   HA   CT   CC       $kmene   0   -70.874  ! methylene his
 improper  HA   HA   CT   C        $kmene   0   -70.874  ! methylene glu, asp
 improper  HA   HA   CT   CP       $kmene   0   -70.874  ! methylene pro
 improper  HA   HA   CP   N        $kmene   0   -70.874  ! methylene pro
 improper  HA   HA   CP   NH3      $kmene   0   -70.874  ! methylene pro

 improper  HA   HA   NH1  C        $kmene   0   -70.874  ! methylene gly
 improper  HA   HA   NH3  C        $kmene   0   -70.874  ! stereo GLY CA at NTER (P. Driscoll 7/25/93)
 improper  HA   HA   CT   NH1      $kmene   0   -70.874  ! methylene arg
 improper  HA   HA   CT   NH3      $kmene   0   -70.874  ! methylene lys
 improper  HA   HA   CT   S        $kmene   0   -73.230  ! methylene cys, met
 improper  HA   HA   CT   OH       $kmene   0   -71.884  ! methylene ser
 improper  HA   HA   CT   N        $kmene   0   -70.874  ! methylene arg
...
!                                                                                radii
 ...
 nonbonded  O       0.2342   2.7755      0.2342   2.7755   !         1.558   1.402   1.246   1.168
 nonbonded  OC      1.0244   2.7755      1.0244   2.7755
 nonbonded  OH      0.2342   2.7755      0.2342   2.7755
 nonbonded  S       0.0239   3.7458      0.0239   3.7458   !         2.102   1.892   1.682   1.577
