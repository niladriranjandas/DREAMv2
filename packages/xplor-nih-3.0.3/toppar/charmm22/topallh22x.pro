 ...
 GROUP  
       ATOM  CD    TYPE=CT2  CHARGE=     .2000  END  
       ATOM  HD1   TYPE=HA   CHARGE=     .0900  END  
       ATOM  HD2   TYPE=HA   CHARGE=     .0900  END  
       ATOM  NE    TYPE=NC2  CHARGE=    -.7000  END  
       ATOM  HE    TYPE=HC   CHARGE=     .4400  END  
       ATOM  CZ    TYPE=C    CHARGE=     .6400  END  
       ATOM  NH1   TYPE=NC2  CHARGE=    -.8000  END  
       ATOM  HH11  TYPE=HC   CHARGE=     .4600  END  
       ATOM  HH12  TYPE=HC   CHARGE=     .4600  END  
       ATOM  NH2   TYPE=NC2  CHARGE=    -.8000  END  
       ATOM  HH21  TYPE=HC   CHARGE=     .4600  END  
       ATOM  HH22  TYPE=HC   CHARGE=     .4600  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP						    !  HA-CA--CB--CG 
       ...
       ATOM  HB2   TYPE=HA   CHARGE=     .0900  END !   O=C 
       ATOM  CG    TYPE=CC   CHARGE=     .6200  END !     | 
       ATOM  OD1   TYPE=OC   CHARGE=    -.7600  END  
       ATOM  OD2   TYPE=OC   CHARGE=    -.7600  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP						    !     | 
       ...
       ATOM  HG1   TYPE=HA   CHARGE=     .0900  END  
       ATOM  HG2   TYPE=HA   CHARGE=     .0900  END  
       ATOM  CD    TYPE=CC   CHARGE=     .6200  END  
       ATOM  OE1   TYPE=OC   CHARGE=    -.7600  END  
       ATOM  OE2   TYPE=OC   CHARGE=    -.7600  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP  
       ...
       ATOM  HD2   TYPE=HA   CHARGE=     .0900  END  
 GROUP  
       ATOM  CE    TYPE=CT2  CHARGE=     .2100  END  
       ATOM  HE1   TYPE=HA   CHARGE=     .0500  END  
       ATOM  HE2   TYPE=HA   CHARGE=     .0500  END  
       ATOM  NZ    TYPE=NH3  CHARGE=    -.3000  END  
       ATOM  HZ1   TYPE=HC   CHARGE=     .3300  END  
...
!      BOND  H1    H2    ! the last bond is needed for shake (not in Xplor!!!)
 ...
 GROUP  ! use in generate statement 
      ...
      ADD  ATOM  +HT1   TYPE=HC   CHARGE=     .3300  END !         HT1 
 ...
 GROUP  ! use in generate statement 
      MODI ATOM  -C     TYPE=CC   CHARGE=     .3400  END !   OT2 
      ADD  ATOM  -OT1   TYPE=OC   CHARGE=    -.6700  END !  // 
      ADD  ATOM  -OT2   TYPE=OC   CHARGE=    -.6700  END ! -C 
      DELE ATOM  -O        END 				 !  \\ 
 !END GROUP						 !   OT1 
