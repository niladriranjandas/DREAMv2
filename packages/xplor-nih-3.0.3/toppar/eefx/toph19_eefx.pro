...
RESIdue ARG
 ...
 GROUp
  ...
  ATOM HE    TYPE=H     CHARge= 0.15   END  !#
  ATOM CZ    TYPE=CR    CHARge= 0.25   END  !#
 GROUp
  ATOM NH1   TYPE=NC2   CHARge= -0.85  END  !#
  ATOM HH11  TYPE=HC    CHARge=  0.40  END  !#
  ATOM HH12  TYPE=HC    CHARge=  0.40  END  !#
 GROUp
  ATOM NH2   TYPE=NC2   CHARge= -0.85  END  !#
...
RESIdue ASP
 GROUp
  ...
  ATOM CA   TYPE=CH1E  CHARge= 0.10   END
 GROUp 
  ATOM CB   TYPE=CH2E  CHARge=-0.15   END
  ATOM CG   TYPE=C     CHARge= 1.35   END
...
RESIdue GLU
 ...
 GROUp
  ATOM CB   TYPE=CH2E  CHARge= 0.00   END
 GROUp
  ATOM CG   TYPE=CH2E  CHARge=-0.15   END
  ATOM CD   TYPE=C     CHARge= 1.35   END
...
RESIdue HIS    ! Rings charges from Del Bene and Cohen 
 ...
 GROUp
  ...
  ATOM NE2  TYPE=NR    CHARge=-0.40   END  !#
  ATOM CE1  TYPE=CR1E  CHARge= 0.30   END  !#
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
RESIdue HSD    ! see HIS above.
 ...
 GROUp
  ATOM CG   TYPE=CR    CHARge= 0.10   END
  ATOM ND1  TYPE=NR    CHARge=-0.40   END  !#
  ATOM CE1  TYPE=CR1E  CHARge= 0.30   END  !#
 GROUp
  ATOM CD2  TYPE=CR1E  CHARge= 0.10   END
  ATOM NE2  TYPE=NH1   CHARge=-0.40   END  !#
  ATOM HE2  TYPE=H     CHARge= 0.30   END  !#
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
RESIdue LYS
 ...
 GROUp
  ...
  ATOM NZ   TYPE=NH3   CHARge=-1.35   END  !#
  ATOM HZ1  TYPE=HC    CHARge= 0.45   END  !#
  ATOM HZ2  TYPE=HC    CHARge= 0.45   END  !#
  ATOM HZ3  TYPE=HC    CHARge= 0.45   END  !#
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
PRESidue NTER             { can be patched ( as NTER - * ... )
 ...
 GROUp
  ...
  MODIfy ATOM +N    TYPE=NH3  CHARge=-1.35 END
  ADD    ATOM +HT3  TYPE=HC   CHARge=0.45  END
  DELETE ATOM +H                           END
...
PRESidue CTER                { C-terminal for all amino acids
                                           ... * - CTER          }
 GROUp
  MODIfy ATOM -C             CHARge= 1.2  END
  ADD    ATOM -OT1  TYPE=OC  CHARge=-0.6  END
  ADD    ATOM -OT2  TYPE=OC  CHARge=-0.6  END
  DELETE ATOM -O                           END
