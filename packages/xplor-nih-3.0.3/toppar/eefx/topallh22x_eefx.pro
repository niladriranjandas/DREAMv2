 ...
 REMARKS FILENAME="topallh22x.pro"
 ...
 MASS HE1    1.0080 ! for alkene; RHC=CR
 MASS HE2    1.0080 ! for alkene; H2C=CR
 ...
 MASS CE1   12.0110 ! for alkene; RHC=CR
 MASS CE2   12.0110 ! for alkene; H2C=CR
 ...
 MASS HE     4.0026 ! helium
 MASS NE    20.1797 ! neon
 ...
 GROUP  
       ATOM  CD    TYPE=CT2  CHARGE=     .0000  END  
       ATOM  HD1   TYPE=HA   CHARGE=     .0500  END  
       ATOM  HD2   TYPE=HA   CHARGE=     .0500  END  
       ATOM  NE    TYPE=NC2  CHARGE=    -.4000  END  
       ATOM  HE    TYPE=HC   CHARGE=     .1500  END  
       ATOM  CZ    TYPE=C    CHARGE=     .2500  END  
       ATOM  NH1   TYPE=NC2  CHARGE=    -.8500  END  
       ATOM  HH11  TYPE=HC   CHARGE=     .4000  END  
       ATOM  HH12  TYPE=HC   CHARGE=     .4000  END  
       ATOM  NH2   TYPE=NC2  CHARGE=    -.8500  END  
       ATOM  HH21  TYPE=HC   CHARGE=     .4000  END  
       ATOM  HH22  TYPE=HC   CHARGE=     .4000  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP  
       ATOM  ND2   TYPE=NH2  CHARGE=    -.6200  END  
       ATOM  HD21  TYPE=H    CHARGE=     .3200  END  
       ATOM  HD22  TYPE=H    CHARGE=     .3000  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP						    !  HA-CA--CB--CG 
       ...
       ATOM  HB1   TYPE=HA   CHARGE=     .0900  END !     |   HB2   OD2 
       ATOM  HB2   TYPE=HA   CHARGE=     .0900  END !   O=C 
       ATOM  CG    TYPE=CC   CHARGE=     1.300  END !     | 
       ATOM  OD1   TYPE=OC   CHARGE=    -.6000  END  
       ATOM  OD2   TYPE=OC   CHARGE=    -.6000  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP						    !  HA-CA--CB--SG 
       ...
       ATOM  HG1   TYPE=HS   CHARGE=     .1600  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
      ...
      DIHEDRAL  CA  CB  SG  HG1  ! multiple dihedral
      DIHEDRAL  CA  CB  SG  HG1  ! multiple dihedral
      DIHEDRAL  CA  CB  SG  HG1  ! multiple dihedral
 ...
 GROUP  
       ATOM  NE2   TYPE=NH2  CHARGE=    -.6200  END  
       ATOM  HE21  TYPE=H    CHARGE=     .3200  END  
       ATOM  HE22  TYPE=H    CHARGE=     .3000  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP						    !     | 
       ...
       ATOM  HG1   TYPE=HA   CHARGE=     .0900  END  
       ATOM  HG2   TYPE=HA   CHARGE=     .0900  END  
       ATOM  CD    TYPE=CC   CHARGE=     1.300  END  
       ATOM  OE1   TYPE=OC   CHARGE=    -.6000  END  
       ATOM  OE2   TYPE=OC   CHARGE=    -.6000  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP  
       ...
       ATOM  HA    TYPE=HB   CHARGE=     .0900  END !     |   |     /      | 
 GROUP						    !  HA-CA--CB--CG       | 
       ATOM  NE2   TYPE=NR1  CHARGE=    -.3600  END !     |   |     \      | 
       ATOM  HE2   TYPE=H    CHARGE=     .3200  END !     |   HB2    CD2--NE2 
       ATOM  CD2   TYPE=CPH1 CHARGE=    -.0500  END !   O=C           |     \ 
       ATOM  HD2   TYPE=HR3  CHARGE=     .0900  END !     |          HD2    HE2 
 GROUP  
       ATOM  ND1   TYPE=NR2  CHARGE=    -.7000  END  
       ATOM  CG    TYPE=CPH1 CHARGE=     .2200  END  
       ATOM  CE1   TYPE=CPH2 CHARGE=     .2500  END  
       ATOM  HE1   TYPE=HR1  CHARGE=     .1300  END  
 ...
 GROUP						    !  HA-CA--CB--CG       | 
       ...
       ATOM  HD1   TYPE=H    CHARGE=     .4400  END !     |   HB2    CD2--NE2 
       ATOM  NE2   TYPE=NR3  CHARGE=    -.5100  END !   O=C           |     \ 
       ATOM  HE2   TYPE=H    CHARGE=     .4400  END !     |          HD2    HE2 
       ATOM  CE1   TYPE=CPH2 CHARGE=     .3200  END  
       ATOM  HE1   TYPE=HR2  CHARGE=     .1800  END  
 GROUP  
       ATOM  CD2   TYPE=CPH1 CHARGE=     .1900  END  
 ...
 GROUP  
       ATOM  CD    TYPE=CT3  CHARGE=    -.2700  END  
       ATOM  HD1   TYPE=HA   CHARGE=     .0900  END  
       ATOM  HD2   TYPE=HA   CHARGE=     .0900  END  
       ATOM  HD3   TYPE=HA   CHARGE=     .0900  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP  
       ...
       ATOM  NZ    TYPE=NH3  CHARGE=    -1.350  END  
       ATOM  HZ1   TYPE=HC   CHARGE=     .4500  END  
       ATOM  HZ2   TYPE=HC   CHARGE=     .4500  END  
       ATOM  HZ3   TYPE=HC   CHARGE=     .4500  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP						    !  HA-CA--CB--OG 
       ...
       ATOM  HG1   TYPE=H    CHARGE=     .4300  END  
 GROUP  
       ATOM  C     TYPE=C    CHARGE=     .5100  END  
       ATOM  O     TYPE=O    CHARGE=    -.5100  END  
 !END GROUP
 ...
 GROUP  
       ...
       ATOM  HA    TYPE=HB   CHARGE=     .0900  END !     |    / 
 GROUP						    !  HA-CA--CB-HB 
       ATOM  CB    TYPE=CT1  CHARGE=     .1400  END !     |    \ 
       ATOM  HB    TYPE=HA   CHARGE=     .0900  END !     |     CG2--HG21 
       ATOM  OG1   TYPE=OH1  CHARGE=    -.6600  END !   O=C    / \ 
       ATOM  HG1   TYPE=H    CHARGE=     .4300  END !     | HG21 HG22 
 GROUP  
...
!      BOND  H1    H2    ! the last bond is needed for shake (not in Xplor!!!)
 ...
 GROUP  ! use in generate statement 
      MODI ATOM  +N     TYPE=NH3  CHARGE=   -1.3600  END ! 
      ADD  ATOM  +HT1   TYPE=HC   CHARGE=     .3500  END !         HT1 
      ADD  ATOM  +HT2   TYPE=HC   CHARGE=     .3500  END !        / 
      ADD  ATOM  +HT3   TYPE=HC   CHARGE=     .3500  END ! --CA--N--HT2 
      MODI ATOM  +CA    TYPE=CT1  CHARGE=     .2100  END !   |    \ 
 ...
 GROUP  ! use in generate statement 
      MODI ATOM  -C     TYPE=CC   CHARGE=    1.2000  END !   OT2 
      ADD  ATOM  -OT1   TYPE=OC   CHARGE=    -.6000  END !  // 
      ADD  ATOM  -OT2   TYPE=OC   CHARGE=    -.6000  END ! -C 
      DELE ATOM  -O        END 				 !  \\ 
 !END GROUP						 !   OT1 
 ...
 GROUP ! use in a patch statement
      MODI ATOM  1CB   TYPE=CT2  CHARGE=    -.1000  END !
      MODI ATOM  1SG   TYPE=SM   CHARGE=    -.0800  END !           2SG--2CB--
 GROUP                                                  !          /
      MODI ATOM  2CB   TYPE=CT2  CHARGE=    -.1000  END !
      MODI ATOM  2SG   TYPE=SM   CHARGE=    -.0800  END ! -1CB--1SG
      DELE ATOM  1HG     END 
      DELE ATOM  2HG     END 
 !END GROUP
