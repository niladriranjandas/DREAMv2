...
MASS   LP     0.00000 ! ST2 LONE PAIR ---Tian
...
MASS   CM    12.01100 ! carbon in carbonmonoxide  ---Tian
...
MASS   OM    15.99940 ! oxygen in carbonmonoxide  ---Tian
MASS   S     32.06000! sulphur
MASS   SH1E  33.06800! extended atom sulfur with one hydrogen
MASS   FE    55.84700 ! iron   ---Tian
MASS   CR    12.01100 ! 4-bonded carbon in aromatics and Arginine  ---Tian
...
RESIdue ARG
 GROUp
  ...
  ATOM CA    TYPE=CH1E  CHARge= 0.10   END
 GROUp 
  ATOM CB    TYPE=CH2E  CHARge=-0.04   END
  ATOM CG    TYPE=CH2E  CHARge=-0.04   END
 GROUp
  ATOM CD    TYPE=CH2E  CHARge=-0.20   END  !#
  ATOM NE    TYPE=NH1   CHARge=-0.20   END  !#
  ATOM HE    TYPE=H     CHARge= 0.12   END  !#
  ATOM CZ    TYPE=CR    CHARge=-0.20   END  !#
 GROUp
...
RESIdue ARH   !! This is deprotonated ARG
 GROUp
  ATOM N     TYPE=NH1   CHARge=-0.35   END
  ATOM H     TYPE=H     CHARge= 0.25   END
  ATOM CA    TYPE=CH1E  CHARge= 0.10   END
 ...
 GROUp
  ...
  ATOM CZ    TYPE=CR    CHARge= 0.20   END  !#
 GROUp
  ATOM NH1   TYPE=NH2   CHARge=-0.600  END  !#
  ATOM HH11  TYPE=H     CHARge= 0.300  END  !#
  ATOM HH12  TYPE=H     CHARge= 0.300  END  !#
 GROUp
  ATOM NH2   TYPE=NH1   CHARge=-0.35  END  !#
  ATOM HH21  TYPE=H     CHARge= 0.25  END  !#
!!  ATOM HH22  TYPE=HC    CHARge= 0.2005  END  !#
 GROUp
  ATOM C     TYPE=C     CHARge=  0.55  END  !#
  ATOM O     TYPE=O     CHARge= -0.55  END  !#
...
RESIdue ASN
 ...
 GROUp
  ATOM ND2  TYPE=NH2   CHARge=-0.50   END  !#
  ATOM HD21 TYPE=H     CHARge= 0.25   END  !#
  ATOM HD22 TYPE=H     CHARge= 0.25   END  !#
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
RESIdue ASP
 ...
 GROUp 
  ATOM CB   TYPE=CH2E  CHARge= 0.00   END
  ATOM CG   TYPE=C     CHARge= 1.00   END
  ATOM OD1  TYPE=OC    CHARge=-0.50   END
  ATOM OD2  TYPE=OC    CHARge=-0.50   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
RESIdue ASH   !!This is protonated ASP
 GROUp
  ATOM N    TYPE=NH1   CHARge=-0.35   END
  ATOM H    TYPE=H     CHARge= 0.25   END
  ATOM CA   TYPE=CH1E  CHARge= 0.10   END
 GROUp 
  ...
  ATOM CG   TYPE=C     CHARge= 0.55   END
  ATOM OD1  TYPE=O     CHARge=-0.55   END
  ATOM OD2  TYPE=OH1   CHARge=-0.50   END
  ATOM HD2  TYPE=H     CHARge= 0.25   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
!! ACCEptor OD2 CG
 ...
 IC   CA   CB   CG   OD1    0.0000    0.00  180.00    0.00   0.0000
 IC   OD1  CB   *CG  OD2    0.0000    0.00  180.00    0.00   0.0000
 IC   CB   *CG  OD2  HD2    0.0000    0.00  180.00    0.00   0.0000
...
RESIdue GLN
 ...
 GROUp
  ATOM NE2  TYPE=NH2   CHARge=-0.50   END
  ATOM HE21 TYPE=H     CHARge= 0.25   END
  ATOM HE22 TYPE=H     CHARge= 0.25   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END
  ATOM O    TYPE=O     CHARge=-0.55   END
...
RESIdue GLU
 ...
 GROUp
  ATOM CG   TYPE=CH2E  CHARge= 0.00   END
  ATOM CD   TYPE=C     CHARge= 1.00   END
  ATOM OE1  TYPE=OC    CHARge=-0.50   END
  ATOM OE2  TYPE=OC    CHARge=-0.50   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END   !#
  ATOM O    TYPE=O     CHARge=-0.55   END   !#
...
RESIdue GLH    !! protonated GLU
 ...
 GROUp
  ATOM CB   TYPE=CH2E  CHARge= 0.00   END
 GROUp
  ATOM CG   TYPE=CH2E  CHARge= 0.25   END
  ATOM CD   TYPE=C     CHARge= 0.55   END
  ATOM OE1  TYPE=O     CHARge=-0.55   END
  ATOM OE2  TYPE=OH1   CHARge=-0.50   END
  ATOM HE2  TYPE=H     CHARge= 0.25   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END   !#
  ATOM O    TYPE=O     CHARge=-0.55   END   !#
...
!! ACCEptor OE2 CD
 ...
 IC   CB   CG   CD   OE1    0.0000    0.00  180.00    0.00   0.0000
 IC   OE1  CG   *CD  OE2    0.0000    0.00  180.00    0.00   0.0000
 IC   CG   *CD  OE2  HE2    0.0000    0.00  180.00    0.00   0.0000
...
RESIdue HIS    ! Rings charges from Del Bene and Cohen 
               ! JACS 100:5285 (1978) Imidazole sto-3g calc.
 GROUp
  ATOM N    TYPE=NH1   CHARge=-0.35   END
  ATOM H    TYPE=H     CHARge= 0.25   END
  ATOM CA   TYPE=CH1E  CHARge= 0.10   END
 GROUp
  ATOM CB   TYPE=CH2E  CHARge= 0.00   END
 GROUp
  ATOM CG   TYPE=CR    CHARge= 0.10   END
  ATOM ND1  TYPE=NH1   CHARge=-0.40   END  !#
  ATOM HD1  TYPE=H     CHARge= 0.30   END  !#
 GROUp
  ATOM CD2  TYPE=CR1E  CHARge= 0.10   END
  ATOM NE2  TYPE=NR    CHARge=-0.30   END  !#
  ATOM CE1  TYPE=CR1E  CHARge= 0.20   END  !#
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
!------------------------------------------------------------------
RESIdue HSC    ! Doubly protonated histidine. Ring Charges
 ...
 GROUp
  ATOM CB   TYPE=CH2E  CHARge= 0.00   END
  ATOM CG   TYPE=CR    CHARge= 0.05   END
  ATOM CD2  TYPE=CR1E  CHARge= 0.05   END
 GROUp
  ATOM ND1  TYPE=NH1   CHARge=-0.55   END  
  ATOM HD2  TYPE=H     CHARge= 0.45   END  
 GROUp
  ATOM CE1  TYPE=CR1E  CHARge= 0.10   END  
 GROUp
  ATOM NE2  TYPE=NH1   CHARge=-0.55   END  
  ATOM HE2  TYPE=H     CHARge= 0.45   END  
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  
  ATOM O    TYPE=O     CHARge=-0.55   END  
...
RESIdue LYS
 ...
 GROUp
  ...
  ATOM CD   TYPE=CH2E  CHARge= 0.00   END
 GROUp
  ATOM CE   TYPE=CH2E  CHARge= 0.00   END  !#
  ATOM NZ   TYPE=NH3   CHARge=-0.90   END  !#
  ATOM HZ1  TYPE=HC    CHARge= 0.30   END  !#
  ATOM HZ2  TYPE=HC    CHARge= 0.30   END  !#
  ATOM HZ3  TYPE=HC    CHARge= 0.30   END  !#
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
RESIdue LYH  !! Deprotonated LYS
 ...
 GROUp
  ATOM CE   TYPE=CH2E  CHARge= 0.00   END  !#
  ATOM NZ   TYPE=NH3   CHARge=-0.60   END  !#
  ATOM HZ1  TYPE=HC    CHARge= 0.30   END  !#
  ATOM HZ2  TYPE=HC    CHARge= 0.30   END  !#
!!  ATOM HZ3  TYPE=HC    CHARge= 0.30   END  !#
 GROUp
...
RESIdue SER
 ...
 GROUp
  ATOM CB   TYPE=CH2E  CHARge= 0.25   END  !#
  ATOM OG   TYPE=OH1   CHARge=-0.55   END  !#
  ATOM HG   TYPE=H     CHARge= 0.30   END  !#
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
  ATOM O    TYPE=O     CHARge=-0.55   END  !#
...
RESIdue THR
 ...
 GROUp
  ...
  ATOM OG1  TYPE=OH1   CHARge=-0.55   END  !#
  ATOM HG1  TYPE=H     CHARge= 0.30   END  !#
 GROUp
  ATOM CG2  TYPE=CH3E  CHARge= 0.00   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55   END  !#
...
! with the histidine angle parameters and to preserve symmetry.
 ...
 IC   N    C    *CA  CB     0.0000    0.00  120.00    0.00   0.0000
 IC   N    CA   CB   CG     0.0000    0.00  180.00    0.00   0.0000
 IC   CA   CB   CG   CD2    0.0000    0.00  180.00    0.00   0.0000
...
RESIdue TYR
 ...
 GROUp
  ...
  ATOM OH   TYPE=OH1   CHARge=-0.55  END
  ATOM HH   TYPE=H     CHARge= 0.30  END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.55  END
  ATOM O    TYPE=O     CHARge=-0.55  END
...
PRESidue NTER             { can be patched ( as NTER - * ... )
 ...
 GROUp
  ADD    ATOM +HT1  TYPE=HC   CHARge=0.30  END
  ADD    ATOM +HT2  TYPE=HC   CHARge=0.30  END
  MODIfy ATOM +N    TYPE=NH3  CHARge=-0.90 END
  ADD    ATOM +HT3  TYPE=HC   CHARge=0.30  END
  DELETE ATOM +H                           END
  MODIfy ATOM +CA             CHARge=0.00  END
 ...
 ADD IC   +HT1  +N    +CA  +C      0.0000    0.00  180.00    0.00   0.0000
 ADD IC   +HT2  +CA   *+N  +HT1    0.0000    0.00  120.00    0.00   0.0000
 ADD IC   +HT3  +CA   *+N  +HT2    0.0000    0.00  120.00    0.00   0.0000
...
PRESidue PROP                { this is the N-terminal for PROlines
                               PROP - PRO -...                      }
 GROUp
  ADD    ATOM +HT1  TYPE=HC   CHARge= 0.45   END
  ADD    ATOM +HT2  TYPE=HC   CHARge= 0.45   END
  MODIfy ATOM +N    TYPE=NH3  CHARge=-1.40   END
  MODIfy ATOM +CD   TYPE=CH2E CHARge= 0.25   END
...
PRESidue CTER                { C-terminal for all amino acids
                                           ... * - CTER          }
 GROUp
  MODIfy ATOM -C             CHARge= 1.00  END
  ADD    ATOM -OT1  TYPE=OC  CHARge=-0.50  END
  ADD    ATOM -OT2  TYPE=OC  CHARge=-0.50  END
  DELETE ATOM -O                           END
