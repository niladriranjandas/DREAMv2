REMARKS TOPH11.PRO ( from TOPH10.INP)
REMARKS =============================
...
REMARKS DNA/RNA atoms appended .
REMARKS few atoms never referenced switched off.
...
RESIdue ASN
 ...
 GROUp
  ATOM CB   TYPE=CH2E  CHARge= 0.00   END
 GROUp
  ATOM CG   TYPE=C     CHARge= 0.45   END
  ATOM OD1  TYPE=O     CHARge=-0.45   END
 GROUp
...
RESIdue GLN
 ...
 GROUp
  ...
  ATOM CG   TYPE=CH2E  CHARge= 0.00   END
 GROUp 
  ATOM CD   TYPE=C     CHARge= 0.45   END
  ATOM OE1  TYPE=O     CHARge=-0.45   END
 GROUp
...
RESIdue HIS    { Doubly protonated histidine.  Ring charges
 ...
 GROUp
  ATOM ND1  TYPE=NH1   CHARge=-0.25   END
  ATOM HD1  TYPE=H     CHARge= 0.32   END
 GROUp
  ATOM CE1  TYPE=CR1E  CHARge= 0.41   END
 GROUp
  ATOM NE2  TYPE=NH1   CHARge=-0.25   END
  ATOM HE2  TYPE=H     CHARge= 0.32   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.45   END
  ATOM O    TYPE=O     CHARge=-0.45   END
...
RESIdue LYS
 ...
 GROUp
  ATOM CE   TYPE=CH2E  CHARge= 0.22   END
  ATOM NZ   TYPE=NH3   CHARge= 0.00   END
  ATOM HZ1  TYPE=HC    CHARge= 0.26   END
  ATOM HZ2  TYPE=HC    CHARge= 0.26   END
  ATOM HZ3  TYPE=HC    CHARge= 0.26   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.45   END
  ATOM O    TYPE=O     CHARge=-0.45   END
...
RESIdue SER
 ...
 GROUp
  ...
  ATOM OG   TYPE=OH1   CHARge=-0.40   END
  ATOM HG   TYPE=H     CHARge= 0.25   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.45   END
  ATOM O    TYPE=O     CHARge=-0.45   END
...
RESIdue THR
 GROUp
  ...
  ATOM CA   TYPE=CH1E  CHARge= 0.10   END
 GROUp
  ATOM CB   TYPE=CH1E  CHARge= 0.15   END
  ATOM OG1  TYPE=OH1   CHARge=-0.40   END
  ATOM HG1  TYPE=H     CHARge= 0.25   END
 GROUp
  ATOM CG2  TYPE=CH3E  CHARge= 0.00   END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.45   END
...
RESIdue TRP
 ...
 GROUp
  ...
  ATOM NE1  TYPE=NH1   CHARge=-0.26  EXCL=(CE2 CE3 CZ2 CZ3 CH2)             END
  ATOM HE1  TYPE=H     CHARge= 0.20   END
 GROUp 
...
RESIdue TYR
 ...
 GROUp
  ...
  ATOM CE2  TYPE=CR1E  CHARge= 0.00  END
 GROUp
  ATOM CZ   TYPE=C     CHARge= 0.15  END
  ATOM OH   TYPE=OH1   CHARge=-0.40  END
  ATOM HH   TYPE=H     CHARge= 0.25  END
 GROUp
  ATOM C    TYPE=C     CHARge= 0.45  END
  ATOM O    TYPE=O     CHARge=-0.45  END
...
RESIdue ETH
 ...
 GROUp
  ATOM C1   TYPE=CH2E    CHARge= 0.15  END
  ATOM O    TYPE=OH1     CHARge=-0.40  END
  ATOM H    TYPE=H       CHARge= 0.25  END
...
PRESidue NTER             { can be patched ( as NTER - * ... )
 ...
 GROUp
  ...
  MODIfy ATOM +N    TYPE=NH3  CHARge=0.00  END
...
PRESidue PROP                { this is the N-terminal for PROlines
 ...
 GROUp
  ADD    ATOM +HT1  TYPE=HC   CHARge= 0.26   END
  ADD    ATOM +HT2  TYPE=HC   CHARge= 0.26   END
  MODIfy ATOM +N    TYPE=NH3  CHARge= 0.08   END
  MODIfy ATOM +CD             CHARge= 0.20   END
  MODIfy ATOM +CA             CHARge= 0.20   END
